...
public class Main {
     ...
     *
     * 입력 : 첫 줄에는 공연장의 격자 크기를 나타내는 정수 C와 R이 하나의 공백을 사이에 두고 차례대로 주어진다.
    ...
    public static void main(String[] args) {
        ...
        while (value <= C * R) {
            // 하 -> 상
            for (int i = (R - 1) - heightIndex; i > heightIndex; i--) {
//                System.out.println("하 -> 상 대기좌석번호 : " + value + ", (" + currentColumnValue + ", " + currentRowValue + ")");
                if (value == target) {
                    System.out.print(currentColumnValue + " " + currentRowValue);
                    return;
                }
                currentRowValue++;
                value++;
...
//            System.out.println("하 -> 상 대기좌석번호 : " + value + ", (" + currentColumnValue + ", " + currentRowValue + ")");
            ...
            // 좌 -> 우
            for (int i = widthIndex; i <= (C - 1) - widthIndex; i++) {
//                System.out.println("좌 -> 우 대기좌석번호 : " + value + ", (" + currentColumnValue + ", " + currentRowValue + ")");
                if (value == target) {
                    System.out.print(currentColumnValue + " " + currentRowValue);
                    return;
                }
...
//            System.out.println("좌 -> 우 대기좌석번호 : " + value + ", (" + currentColumnValue + ", " + currentRowValue + ")");
            ...
            // 상 -> 하
            for (int i = heightIndex + 1; i < (R - 1) - heightIndex; i++) {
//                System.out.println("상 -> 하 대기좌석번호 : " + value + ", (" + currentColumnValue + ", " + currentRowValue + ")");
                if (value == target) {
                    System.out.print(currentColumnValue + " " + currentRowValue);
                    return;
                }
...
//            System.out.println("상 -> 하 대기좌석번호 : " + value + ", (" + currentColumnValue + ", " + currentRowValue + ")");
            ...
            // 우 -> 좌
            for (int i = (C - 1) - widthIndex; i > widthIndex; i--) {
//                System.out.println("우 -> 좌 대기좌석번호 : " + value + ", (" + currentColumnValue + ", " + currentRowValue + ")");
                if (value == target) {
                    System.out.print(currentColumnValue + " " + currentRowValue);
                    return;
                }
...
//            System.out.println("우 -> 좌 대기좌석번호 : " + value + ", (" + currentColumnValue + ", " + currentRowValue + ")");
        ...
        // 좌석을 배정할 수 없는 경우에는 0(숫자 영)을 출력해야 한다.
        System.out.print("0");
